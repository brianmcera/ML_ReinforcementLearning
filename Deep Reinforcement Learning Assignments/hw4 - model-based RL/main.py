...
def train(env, 
    ...
    for path in paths:
        if(first):
            ...
            data['observations'] = np.vstack((data['observations'],path['observations']))
            data['next_observations'] = np.vstack((data['next_observations'],path['next_observations']))
