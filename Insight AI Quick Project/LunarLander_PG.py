...
class policyMu(Model):
    ...
    def __init__(self, ob_dim, ac_dim):
        ...
        self.d2 = Dense(20, activation='tanh', kernel_regularizer=tf.keras.regularizers.l2(1e-1))
        self.d3 = Dense(20, activation='tanh', kernel_regularizer=tf.keras.regularizers.l2(1e-1))
        self.d4 = Dense(20, activation='tanh', kernel_regularizer=tf.keras.regularizers.l2(1e-1))
        self.d5 = Dense(20, activation='tanh', kernel_regularizer=tf.keras.regularizers.l2(1e-1))
        self.d6 = Dense(8, activation='tanh', kernel_regularizer=tf.keras.regularizers.l2(1e-1))
        self.d7 = Dense(8, activation='tanh', kernel_regularizer=tf.keras.regularizers.l2(1e-1))
...
def main():
    ...
    optimizer1 = tf.keras.optimizers.SGD(learning_rate=1e-3, momentum=0.9) # baseline optimizer
    optimizer2 = tf.keras.optimizers.SGD(learning_rate=1e-3, momentum=0.9) # controller optimizer - smaller stepsize
